...
def create_invoice():
    ...
    invoice_text.insert(END , f'Informatin: \t{invoice_number}\t\t{invoice_date}\n')
    invoice_text.insert(END , f'*' * 67 + '\n')
    invoice_text.insert(END , f'Items\t\tQuantaty\t\tItems Cost\n')
    ...
    invoice_text.insert(END, f'Thank You!')
